    ...
    <aside id="side-overlay">
        ...
        <div class="content-header border-bottom">
            ...
            <a class="img-link me-1" href="javascript:void(0)">
                <img class="img-avatar img-avatar32" src="https://picsum.photos/30/30?{{ rand(1,100) }}" alt="">
            </a>
            <!-- END User Avatar -->
            ...
            <a class="ms-auto btn btn-sm btn-alt-secondary" href="javascript:void(0)" data-toggle="layout"
                                        ...
                                        <a class="d-flex py-2" href="javascript:void(0)">
                                            <div class="me-3 ms-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48"
                                                     src="https://picsum.photos/48/48?{{ rand(1,100) }}" alt="">
                                                <span
